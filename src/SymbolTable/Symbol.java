 ...
 * A symbol can be a variable, function, parameter, or import.
 */
public class Symbol {
    public enum SymbolType {
        ...
        IMPORT,      // Imported module/name
        LOOP_VAR,    // Loop variable (for/while loops)
        BUILTIN      // Built-in variable (e.g., __name__)
    }
